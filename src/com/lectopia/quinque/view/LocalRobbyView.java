...
public class LocalRobbyView extends JPanel {
	...
	public LocalRobbyView() {
		...
		lblNewLabel.setIcon(new ImageIcon(LocalRobbyView.class.getResource("/localView/bear.png")));
		lblNewLabel.setBounds(12, 412, 288, 290);
		add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon(LocalRobbyView.class.getResource("/localView/babyBear.png")));
		...
		button_1.setIcon(new ImageIcon(LocalRobbyView.class.getResource("/localView/return.png")));
		...
		button_2.setIcon(new ImageIcon(LocalRobbyView.class.getResource("/localView/play.png")));
		...
		comboBox.addItem(new ImageIcon(LocalRobbyView.class.getResource("/localView/rabitface.png")));
		comboBox.addItem(new ImageIcon(LocalRobbyView.class.getResource("/localView/turtleface.png")));
		comboBox.setBounds(692, 322, 73, 60);
		add(comboBox);
		
		comboBox_1 = new JComboBox<ImageIcon>();
		comboBox_1.addItem(new ImageIcon(LocalRobbyView.class.getResource("/localView/rabitface.png")));
		comboBox_1.addItem(new ImageIcon(LocalRobbyView.class.getResource("/localView/turtleface.png")));
