...
//	/**
//	 * 맵 타일의 상태가 퀸키스톤의 말(Marker)이 이동할 수 있는 상태인지 여부에 대한 정보를 담고 있는 변수이다.
//	 * <br>- default 값은 false로 말이 이동할 수 없는 맵 타일임을 의미한다.
//	 * <br>- 값이 true인 맵 타일은 말(Marker)이 이동할 수 있는 맵 타일임을 의미한다.
//	 */
...
//	/**
//	 * 맵 타일 클래스의 인스턴스 객체의 말이 이동할 수 있는 타일인지 여부(boolean)를 반환하는 메서드이다.
//	 * @return 맵 타일이 말이 이동할 수 있는 타일인지 여부 (boolean)
//	 */
...
//	
//	/**
//	 * 맵 타일 클래스의 인스턴스 객체의 말이 이동할 수 있는 타일인지 여부(boolean)를 설정하는 메서드이다.
//	 * @param available 맵 타일에 대하여 설정할 말이 이동할 수 있는 타일인지 여부에 대한 값 (boolean)
//	 */
